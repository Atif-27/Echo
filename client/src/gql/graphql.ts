...
export type GetUserByIdQuery = { __typename?: 'Query', getUserById?: { __typename?: 'User', firstName: string, lastName?: string | null, profileImage: string, id: string, tweets?: Array<{ __typename?: 'Tweet', id: string, content: string, imageURL?: string | null, author?: { __typename?: 'User', id: string, firstName: string, profileImage: string, lastName?: string | null } | null } | null> | null } | null };
